...
| --- | ---: | ---: | ---: | --- |
| `gemma4:31b-cloud` | 765.0/800.0 (95.6%) | 87.5% | 21.1s | ok |
| `ornith:latest` | 800.0/800.0 (100.0%) | 100.0% | 66.9s | ok |
| `hf.co/RefinedNeuro/RefinedToolCallV5-3b:Q8_0` | 510.0/800.0 (63.7%) | 50.0% | 41.7s | ok |

## Speed Comparison

| Model | Duration | Relative To Fastest |
| --- | ---: | ---: |
| `gemma4:31b-cloud` | 21.1s | 1.00x |
| `ornith:latest` | 66.9s | 3.18x |
| `hf.co/RefinedNeuro/RefinedToolCallV5-3b:Q8_0` | 41.7s | 1.98x |
